...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonLongClick.setOnLongClickListener(v -> {
            Toast.makeText(MainActivity.this,"Button Long Clicked", Toast.LENGTH_LONG).show();
            return true;
        });
        ...
        editTextFocus.setOnFocusChangeListener((v, hasFocus) -> {
            if (hasFocus) {
                Toast.makeText(MainActivity.this, "EditText Focused", Toast.LENGTH_LONG).show();
            } else {
                Toast.makeText(MainActivity.this, "EditText Lost Focus", Toast.LENGTH_LONG).show();
            }
        });
        ...
        editTextKey.setOnKeyListener(new View.OnKeyListener() {
            ...
            public boolean onKey(View v, int keyCode, KeyEvent event) {
                if (keyCode == KeyEvent.KEYCODE_ENTER) {
                    Toast.makeText(MainActivity.this, "Enter Key Pressed", Toast.LENGTH_LONG).show();
                    return true;
                }
                return false;
            }
        ...
        buttonTouch.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                if (event.getAction() == MotionEvent.ACTION_DOWN) {
                    Toast.makeText(MainActivity.this, "Button Touched", Toast.LENGTH_LONG).show();
                    return true;
                }
                return false;
            }
